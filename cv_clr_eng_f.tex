...
\mobile{+33 9 77 19 60 04\\   %+33 
+1 209 435 8210\\
+52 442 124 4086}
\email{carlos@kuodata.com}
...
{\textbf{Keywords:} Recommender systems, Apache Spark, Cassandra, Kafka\\% NLP\\
	...
	%\footnotesize 
	Real-time personalization using recommendation system algorithms in distributed architecture. 5 Million visitors personalized per day and 6 Million emails. %6 months time to market of recommender system from scratch until production. %2\% lift in turnover. 6 Millions emails personalized every day, 3\% lift on click rate
